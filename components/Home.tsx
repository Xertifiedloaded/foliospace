...
const FEATURE_SECTIONS = [
  {
    ...
    description: "Create, edit, and customize your portfolio effortlessly, without any coding expertise.",
  ...
  },
  {
    ...
    description: "Turn your skills into visually compelling narratives, all without the need for coding.",
      ...
      <header className="fixed w-full top-0 z-50 bg-white/90 backdrop-blur-md border-b border-neutral-200 shadow-lg">
        <div className="px-8 py-6 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <RiCheckboxCircleLine className="text-3xl text-blue-600" />
            <span className="text-3xl font-extrabold tracking-tight text-neutral-900">FolioSpace</span>
          </div>
      ...
      <main className="wrapper px-8 pt-32 grid gap-16 lg:grid-cols-2">
        <div className="space-y-8">
          ...
          <p className="lg:text-xl text-sm text-neutral-300 leading-relaxed max-w-2xl">
            Beyond traditional portfolios, we provide a dynamic platform that transforms your professional journey into a
            compelling, strategic narrative that resonates with global opportunities.
          </p>
          ...
          <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-neutral-200 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm bg-white/30 px-3 py-1 rounded-full">Pro</span>
              </div>
