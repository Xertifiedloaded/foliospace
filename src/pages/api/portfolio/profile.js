...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === "PATCH") {
      ...
      const hobbies = fields.hobbies ? JSON.parse(fields.hobbies[0]) : [];
      const languages = fields.languages ? JSON.parse(fields.languages[0]) : [];
      const levelOfExperience = fields.levelOfExperience ? fields.levelOfExperience[0] : null;  
      const yearsOfExperience = fields.yearsOfExperience ? parseInt(fields.yearsOfExperience[0], 10) : null;
